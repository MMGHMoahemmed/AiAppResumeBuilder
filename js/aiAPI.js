...
async function handlePublicKeyUsage(apiKeyUsed) {
    ...
    if (!PUBLIC_GEMINI_API_KEY || PUBLIC_GEMINI_API_KEY === 'AQ.Ab8RN6JRmC9EYMFlCXb46QL0i5bQWEElI_k5SNfvBsJSDrsYjg') return;
...
async function fetchResumeContentFromAI(promptType, jobDesc, contextData, outputLanguage) {
    ...
    const AI_API_ENDPOINT = `https://generativelanguage.googleapis.com/v1beta/models/${modelName}:generateContent`;
